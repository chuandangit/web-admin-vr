...
import com.project.capstone.virtualmobileapp.adapter.OrderAdapter;
import com.project.capstone.virtualmobileapp.utils.CheckConnection;
...
//            priceOrder += MainActivity.orderArrayList.get(i).getPrice();
    ...
    private void direct() {
        ...
        orderAdapter = new OrderAdapter(OrderActivity.this, MainActivity.orderArrayList);
